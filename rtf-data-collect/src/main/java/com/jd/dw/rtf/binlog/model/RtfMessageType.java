...
public class RtfMessageType implements Serializable {
    private long mid = 0;//事务id，要求读取时递增
    private String db = null;
    private String tb = null;
    private long ts = 0;//操作数据库的时间戳
    private String opt = null;//操作insert delete update

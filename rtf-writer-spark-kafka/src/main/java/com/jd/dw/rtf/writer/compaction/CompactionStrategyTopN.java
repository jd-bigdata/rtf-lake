...
import com.jd.dw.rtf.writer.hdfs.HDFSConf;
...
//java -cp RTFWriter-1.0-SNAPSHOT.jar com.jd.dw.rtf.writer.compaction.CompactionStrategyTopN
// "hdfs://ns13/user/dd_edw_rtf/fdm_rtf.db/fdm_pek_orders_rtf_rcnt/"

public class CompactionStrategyTopN {

  private static Configuration conf;
  static {
    conf = HDFSConf.getHdfsConf();
  }

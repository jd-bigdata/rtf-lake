...
public class FilePartition implements Serializable {//Comparable
  ...
  public FilePartition(String filename) {//.rtf.0
    ...
    String[] filenames = filename.split(Constants.FILE_NAME_SPLIT);
  ...
  public boolean isKeyInFile(long key) {

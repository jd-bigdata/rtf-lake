...
//  public static int PARTITION_FACTOR = 1000000;
//  public static int PARTITION_KEY_LENGTH = 6;
//  public static int PARTITION_KEY_SUBLENGTH = 3;
  ...
  public static final String RT_DATA_FLAG = "--rt--";
  ...
  public static final String HIS_FLAG_STR = "-his-";

  public static String LZO_SUFFIX = ".lzo";
  public static String RTF_SUFFIX = ".rtf";
